...
public class ArticlePageObject extends MainPageObject
{
    ...
    public void addArticleToMyList(String name_of_folder)
    {
        ...
        this.waitForElementAndClear(By.id(MY_LIST_NAME_INPUT), "Cannot find input to set name of article folder", 5);
        this.waitForElementAndSendKeys(By.id(MY_LIST_NAME_INPUT), name_of_folder, "Cannot put text into articles folder input", 5);
